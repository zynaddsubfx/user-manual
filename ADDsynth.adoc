...
Amplitude envelopes control the amplitude of the sound while filter envelopes control the cutoff frequency of the filters.

They share the same configuration options.
